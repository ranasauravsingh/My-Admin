...
import laptopMan from "../assets/img/illustrations/man-with-laptop-light.png";
...
import walletImg from "../assets/img/icons/unicons/wallet.png";
import chartImg from "../assets/img/icons/unicons/chart.png";
import ccSuccess from "../assets/img/icons/unicons/cc-success.png";
import warningImg from "../assets/img/icons/unicons/cc-warning.png";
						...
						<div className="card h-100">
							...
							<div className="card-body">
								<ul className="p-0 m-0">
									<li className="d-flex mb-4 pb-1">
										<div className="avatar flex-shrink-0 me-3">
											<img src={paypalImg} alt="User" className="rounded" />
										</div>
										<div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
											<div className="me-2">
									...
									<li className="d-flex mb-4 pb-1">
										<div className="avatar flex-shrink-0 me-3">
											<img src={walletImg} alt="User" className="rounded" />
										</div>
										<div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
											<div className="me-2">
												<small className="text-muted d-block mb-1">
									...
									<li className="d-flex mb-4 pb-1">
										<div className="avatar flex-shrink-0 me-3">
											<img src={chartImg} alt="User" className="rounded" />
										</div>
										<div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
											<div className="me-2">
												<small className="text-muted d-block mb-1">
									...
									<li className="d-flex">
										<div className="avatar flex-shrink-0 me-3">
											<img src={warningImg} alt="User" className="rounded" />
										</div>
										<div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
											<div className="me-2">
												<small className="text-muted d-block mb-1">
