...
const Login = () => {
	...
	const handleSubmit = (event) => {
		...
		// 	setErrors((ccc) => ({ ...ccc, password: "Plz Insert Password First." }));
		// 	toast.error("Plz Insert Password First.", {
		// 		theme: "colored",
		// 		autoClose: 2000,
		// 	});
		// } else {
		...
		if (userFlag === 0) {
			toast.error("Error occur while login, Please check UserName", {
				theme: "colored",
				autoClose: 2000,
			});
		} else if (userFlag === 1) {
			toast.error("Error occur while login, Please check Password", {
				theme: "colored",
				autoClose: 2000,
			});
		}
